...
class AnotherWindow(QWidget):
	...
	def __init__(self,name):
		super().__init__()
		self.name = name
		self.time = jdatetime.datetime.now()
		...
		try:
			...
			with open('daily.json') as dailys:
				self.daily = json.load(dailys)
			# with open('day.json') as days:
			# 	day = json.load(days)
		except:pass
			# day={}
			# with open('day.json','w+') as days:
			# 	json.dump(day,days)
			# with open('day.json','w+') as days:
			#     json.dump(day,days)
			# with open('data.json') as outfile:
		...
		# print(daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{self.name}'])
		...
		# first of all
		for i in range(len(self.dayP)):
			for index in range(len(self.data)):
				if self.data[index]['ID']==self.dayP[i]:
					j1 = self.data[index]['name']
					j2 = self.data[index]['family']
					j3 = self.data[index]['tell']
					self.listWidget.addItem(f'{j1} {j2} {j3}')

		clearBtn = QPushButton('غایبان', self)
		clearBtn.clicked.connect(self.onClearClicked)

		countBtn = QPushButton('شمارش تعداد', self)
		...
		self.setWindowTitle('حاضران')
		self.show()


	def onClearClicked(self):
		self.setWindowTitle('غایبان')
		self.dayL = []
		self.dayL = self.daily['1'][0][f'{self.name}']
		self.listWidget.clear()
		for i in range(len(self.dayL)):
			for index in range(len(self.data)):
				if self.data[index]['ID']==self.dayL[i] and self.dayL[i] not in self.dayP:
					j1 = self.data[index]['name']
					j2 = self.data[index]['family']
					j3 = self.data[index]['tell']
					self.listWidget.addItem(f'{j1} {j2} {j3}')
	...
	def onCountClicked(self):
		...
		QMessageBox.information(self, "Info", 
			f' تعداد دانش آموزیان {self.listWidget.count()}')

		# self.name = name
		# self.vbox = QVBoxLayout(self)
		# self.listWidget = QListWidget(self)
		# self.setWindowTitle("list of class")
		# self.listWidget.setGeometry(QRect(0, 0, 400, 400))
...
class Ui_MainWindow(QtWidgets.QWidget):
	def setupUi(self, MainWindow):
		...
		self.gridLayoutWidget.setGeometry(QtCore.QRect(60, 160, 300, 400))
		...
		self.gridLayoutWidget_2.setGeometry(QtCore.QRect(410, 160, 300, 400))
		...
		self.pushButton_42.setGeometry(QtCore.QRect(415, 419, 78, 32))
		self.pushButton_42.setStyleSheet(showstu)
		...
		# self.label_251 = QtWidgets.QLabel(self.centralwidget)
		# self.label_251.setStyleSheet(layouts_up)
		# self.label_251.setGeometry(QtCore.QRect(700, 510, 10, 70))
		# self.label_252 = QtWidgets.QLabel(self.centralwidget)
		# self.label_252.setStyleSheet(layouts_down)
		# self.label_252.setGeometry(QtCore.QRect(60, 510, 631, 70))
		# self.label_253 = QtWidgets.QLabel(self.centralwidget)
		# self.label_253.setStyleSheet(layouts)
		# self.label_253.setGeometry(QtCore.QRect(610, 570, 100, 30))
		# self.label_254 = QtWidgets.QLabel(self.centralwidget)
		# self.label_254.setStyleSheet(layouts_down)
		# self.label_254.setGeometry(QtCore.QRect(60, 570, 541, 30))




		# self.lineEdit_1 = QtWidgets.QLineEdit(self.centralwidget)
		# self.lineEdit_1.setGeometry(QtCore.QRect(60, 570, 651, 30))
		...
		# self.lineEdit_2.setGeometry(QtCore.QRect(60, 520, 651, 30))
		...
		self.gridLayoutWidget_3.setGeometry(QtCore.QRect(60, 69, 650, 64))
	...
	def retranslateUi(self, MainWindow):
		...
		# self.label_251.setText(_translate("MainWindow", " حاضرین"))
		# self.label_252.setText(_translate("MainWindow", " غایبین "))
		# self.label_253.setText(_translate("MainWindow", " غایبین"))
	...
	def upset(self):
			...
			try:
				...
				daily['0'] = [{"people":[],"teacher":[]}]
				daily['1'] = [{f'{number_of_class[i]}':[] for i in range(len(number_of_class))}]
			...
			for i in range(len(data)):
				for num in number_of_class:
					if data[i]['class'] == num and data[i]['ID'] not in daily['1'][0][num]:
						pass
						daily['1'][0][num].append(data[i]['ID'])
			...
			try:
				for i in range(len(number_of_class)):
					...
					# print(number_of_class)
					# c = len(daily[f'{inyear}-{inmonth}-{inday}'][0][number_of_class[i]])
					if number_of_class[i]==number_of_class[0]:
						...
						self.pushButton_39.clicked.connect(lambda:self.printt(cl4))
					elif number_of_class[i]==number_of_class[4]:
						cl5 = number_of_class[i]
						f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cl5}']
						# self.label_25.setStyleSheet(layouts_up)
						self.label_40.setText(f'{f}')
						self.pushButton_40.clicked.connect(lambda:self.printt(cl5))
					elif number_of_class[i]==number_of_class[5]:
						cl6 = number_of_class[i]
						f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cl6}']
						# self.label_25.setStyleSheet(layouts_up)
						self.label_41.setText(f'{f}')
						self.pushButton_41.clicked.connect(lambda:self.printt(cl6))
					elif number_of_class[i]==number_of_class[6]:
						cl7 = number_of_class[i]
						f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cl7}']
						# self.label_25.setStyleSheet(layouts_up)
						self.label_42.setText(f'{f}')
						self.pushButton_42.clicked.connect(lambda:self.printt(cl7))
					elif number_of_class[i]==number_of_class[7]:
						cl8 = number_of_class[i]
						f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cl8}']
						# self.label_25.setStyleSheet(layouts_up)
						self.label_48.setText(f'{f}')
						self.pushButton_48.clicked.connect(lambda:self.printt(cl8))
					elif number_of_class[i]==number_of_class[8]:
						cl9 = number_of_class[i]
						f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cl9}']
						# self.label_25.setStyleSheet(layouts_up)
						self.label_15.setText(f'{f}')
						self.pushButton_15.clicked.connect(lambda:self.printt(cl9))
					elif number_of_class[i]==number_of_class[9]:
						cl10 = number_of_class[i]
						f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cl10}']
						# self.label_25.setStyleSheet(layouts_up)
						self.label_16.setText(f'{f}')
						self.pushButton_16.clicked.connect(lambda:self.printt(cl10))
					elif number_of_class[i]==number_of_class[10]:
						cl11 = number_of_class[i]
						f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cl11}']
						# self.label_25.setStyleSheet(layouts_up)
						self.label_17.setText(f'{f}')
						self.pushButton_17.clicked.connect(lambda:self.printt(cl11))
					elif number_of_class[i]==number_of_class[11]:
						cl12 = number_of_class[i]
						f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cl12}']
						# self.label_25.setStyleSheet(layouts_up)
						self.label_18.setText(f'{f}')
						self.pushButton_18.clicked.connect(lambda:self.printt(cl12))
					elif number_of_class[i]==number_of_class[12]:
						cl3 = number_of_class[i]
						f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cl13}']
						# self.label_25.setStyleSheet(layouts_up)
						self.label_19.setText(f'{f}')
						self.pushButton_19.clicked.connect(lambda:self.printt(cl13))
					elif number_of_class[i]==number_of_class[13]:
						cl14 = number_of_class[i]
						f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cl14}']
						# self.label_25.setStyleSheet(layouts_up)
						self.label_20.setText(f'{f}')
						self.pushButton_20.clicked.connect(lambda:self.printt(cl14))
					elif number_of_class[i]==number_of_class[14]:
						cl15 = number_of_class[i]
						f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cl15}']
						# self.label_25.setStyleSheet(layouts_up)
						self.label_21.setText(f'{f}')
						self.pushButton_21.clicked.connect(lambda:self.printt(cl15))
					elif number_of_class[i]==number_of_class[15]:
						cl16 = number_of_class[i]
						f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cl16}']
						# self.label_25.setStyleSheet(layouts_up)
			...
			for student in range(len(datadaily[f'{inyear}-{inmonth}-{inday}'])):
				...
				if len(data[student]['personalcode'])==1:
					...
					if int(data[student]['personalcode'])==1:
						if data[student]['ID'] in daily['0'][0]['teacher']:
				...
				for student in range(len(datadaily[f'{inyear}-{inmonth}-{inday}'])):
					if datadaily['0'][student]['ID']==in_pass:
						...
						if len(data[student]["class"])==3:
							...
							try:
								...
								# print("2")
									if data[student]['class']==number_of_class[0]:
										cll1 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll1}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_36.setText(f'{len(f)}')
										# self.label_36.enterEvent(print("sd"))
										self.pushButton_36.clicked.connect(lambda:self.printt(cll1))
										pass
									elif data[student]['class']==number_of_class[1]:
										cll2 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll2}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_37.setText(f'{len(f)}')
										self.pushButton_37.clicked.connect(lambda:self.printt(cll2))
									elif data[student]['class']==number_of_class[2]:
										cll3 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll3}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_38.setText(f'{len(f)}')
										self.pushButton_38.clicked.connect(lambda:self.printt(cll3))
									elif data[student]['class']==number_of_class[3]:
										cll4 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll4}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_39.setText(f'{len(f)}')
										self.pushButton_39.clicked.connect(lambda:self.printt(cll4))
									elif data[student]['class']==number_of_class[4]:
										cll5 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll5}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_40.setText(f'{f}')
										self.pushButton_40.clicked.connect(lambda:self.printt(cll5))
									elif data[student]['class']==number_of_class[5]:
										cll6 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll6}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_41.setText(f'{f}')
										self.pushButton_41.clicked.connect(lambda:self.printt(cll6))
									elif data[student]['class']==number_of_class[6]:
										cll7 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll7}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_42.setText(f'{f}')
										self.pushButton_42.clicked.connect(lambda:self.printt(cll7))
									elif data[student]['class']==number_of_class[7]:
										cll8 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll8}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_48.setText(f'{f}')
										self.pushButton_48.clicked.connect(lambda:self.printt(cll8))
									elif data[student]['class']==number_of_class[8]:
										cll9 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll9}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_15.setText(f'{f}')
										self.pushButton_15.clicked.connect(lambda:self.printt(cll9))
									elif data[student]['class']==number_of_class[9]:
										cll10 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll10}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_16.setText(f'{f}')
										self.pushButton_16.clicked.connect(lambda:self.printt(cll10))
									elif data[student]['class']==number_of_class[10]:
										cll11 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll11}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_17.setText(f'{f}')
										self.pushButton_17.clicked.connect(lambda:self.printt(clcll11))
									elif data[student]['class']==number_of_class[11]:
										cll12 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll12}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_18.setText(f'{f}')
										self.pushButton_18.clicked.connect(lambda:self.printt(cll12))
									elif data[student]['class']==number_of_class[12]:
										cll13 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll13}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_19.setText(f'{f}')
										self.pushButton_19.clicked.connect(lambda:self.printt(cll13))
									elif data[student]['class']==number_of_class[13]:
										cll14 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll14}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_20.setText(f'{f}')
										self.pushButton_20.clicked.connect(lambda:self.printt(cll14))
									elif data[student]['class']==number_of_class[14]:
										cll15 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll15}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_21.setText(f'{f}')
										self.pushButton_21.clicked.connect(lambda:self.printt(cll15))
									elif data[student]['class']==number_of_class[15]:
										cll16 = data[student]['class']
										f=daily[f'{inyear}-{inmonth}-{inday}'][-1][f'{cll16}']
										# self.label_25.setStyleSheet(layouts_up)
										self.label_45.setText(f'{f}')
										self.pushButton_45.clicked.connect(lambda:self.printt(cll16))
								# elif data[student]['personalcode']==number_of_class[16]:
									# pass
									# self.label_47.setStyleSheet(layouts_up)
							...
							# self.label_251.setStyleSheet(layouts_up)
							# lenghts = 651
							# self.label_251.setGeometry(QtCore.QRect(610, 510, 100, 70))
							# # self.label_252 = QtWidgets.QLabel(self.centralwidget)
							# # self.label_252.setStyleSheet(layouts_down)
							# self.label_252.setGeometry(QtCore.QRect(60, 510, 541, 70))
			else:
